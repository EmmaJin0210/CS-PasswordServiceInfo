...
This is the information for the CS password service web application I created with [Jeff Knerr](https://jeffknerr.github.io/) in Summer 2020.
...
- install nginx, webhook, supervisor (see Miguel's [Deployment on Linux](https://blog.miguelgrinberg.com/post/the-flask-mega-tutorial-part-xvii-deployment-on-linux) page for good details)
